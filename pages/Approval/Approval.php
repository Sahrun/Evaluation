<?php include "../../Config/ConfigHead.php"; ?>
  ...
  <div class="content-wrapper">
      ...
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <h4 class="text-center"><strong>Approval Evaluasi Penawaran</strong>
                </h4>
              </div>
            </div>
            <div class="row">
                ...
                <table class="table table-bordered">
                  <thead>
                    ...
                    <tr>
                        <td v-for="(vendor,index) in Evaluation.PRVendor" class="text-center" colspan="5">
                          ...
                          <input type="checkbox"
                          v-model="vendor.IsWinner"
                          :disabled="vendor.Disabled"
                          v-on:change="SelectWinner(vendor.PRVendorId,vendor.IsWinner)">
                        </td>
                    </tr>
                    <tr>
                      <td v-for="(vendor,index) in Evaluation.PRVendor" class="text-center" colspan="5">
                  ...
                  <tbody>
                    <tr v-for="(item , index) in Evaluation.Evaluationdetailvendor">
                      ...
                      <td><input type="checkbox" v-model="vendor.Selected"
                          :disabled="vendor.Disabled"
                          v-on:change="SelectedWinnerVendor(vendor.PRVendorId,item,vendor.Selected)">
                      </td>
    ...
    <div class="row text-right">
      <div class="col-md-12">
        ...
        class="btn  btn-lg btn-success" v-on:click="Approve()"
        v-show="Evaluation.CurrentApproval.IsApprove == 0">
        <input type="button" value="Cancel"  class="btn  btn-lg btn-default" onclick="goBack()">
      </div>
    </div>
  </div>
  <?php include "../../Config/ConfigFooter.php"; ?>
